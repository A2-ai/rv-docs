...
<CardGrid>
	...
	<Card title="Configuration" icon="document">
		<a href="config/intro/">The configurations available for project package management</a>
	</Card>
	<Card title="Commands" icon = "setting">
		<a href="commands/">The commands to interact with your rv project</a> 
	</Card>
	<Card title="Cookbook" icon="open-book">
		<a href="cookbook/intro/">Example projects showing various configurations</a>
	</Card>
</CardGrid>
