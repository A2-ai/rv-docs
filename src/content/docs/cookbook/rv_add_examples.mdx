...
`https://github.com` (or [`git_shorthand_base_url`](../../config/git_shorthand_base_url) if configured). A reference and
...
If [`git_shorthand_base_url`](../../config/git_shorthand_base_url) is set in `rproject.toml` (e.g. for a GitHub Enterprise host),
