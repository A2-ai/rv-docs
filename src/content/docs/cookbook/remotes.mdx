...
As discussed in [`prefer_repositories_for`](../../config/package-compilation/prefer_repositories_for), `rv` has the power to prefer repositories
...
<Tabs syncKey="plan-v-summary">
    <TabItem label="rv summary">
        ...
        == Remote == 
        PPM (https://packagemanager.posit.co/cran/2025-05-01): 19436 binary packages, 22462 source packages
        ```
    </TabItem>
