...
### Example 
We will once again start with the same initial configuration file:
...
### Example 4 - Clear the repositories section
We will once again start with the same initial configuration file:
...
To clear the repositories section we will use the following command:
```shell
