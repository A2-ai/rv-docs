...
`rv plan` will show you what [`sync`](../../package-installation/sync) would do, without sync-ing anything. This is useful to see how the changes to
...
CI/reproducibility use case as [`rv sync --locked`](../../package-installation/sync#using---locked-for-ci). <Badge text = "Introduced in rv 0.22.0" variant = "note"/>
