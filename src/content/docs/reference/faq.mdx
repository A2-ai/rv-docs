...
description: Frequently Asked Questions about rv
---
...
### 1. Your `.Rprofile` is not sourcing `rv/scripts/activate.R`
    * Restart R or run `source(".Rprofile")`. After either, you should see a message containing the following:
        ```txt
        rv libpaths active!
        library paths: 
            /Users/rv-user/project/rv/library/4.4/arm64
