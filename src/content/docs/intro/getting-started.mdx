...
desired project enviroment. During project initialization, the `rproject.toml` is pre-populated with information found in 
your R session.
...
<Aside type="note" title="Info">
Addtional information about commands to installing packages, and other commands, can be found in this section:
...
For more information on how the lock file impacts package installation, see the [resolution section](../../reference/resolution#lockfile)
