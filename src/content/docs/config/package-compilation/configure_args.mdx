...
description: Package and system specific configure.args
---
...
:::caution
As discussed in the [Cache Concept Section](../../../concepts/cache), changing the compilation of a package may affect other projects. If 
...
(using `RV_CACHE_DIR` or `XDG_CACHE_HOME` for unix-like systems) to a separate directory to ensure this does not impact other projects.
:::
