...
* ***Direct** Dependencies* - These are the packages explicity stated in the [dependencies section](../../config/common_config/#dependencies)
 of your config file. Direct dependencies can have [additional configurations](../../config/common_config/#dependencies), 
...
acceptable version constraint, and occassionally [a remote source](https://r-pkgs.org/dependencies-in-practice.html#depending-on-the-development-version-of-a-package).
...
Like we have discussed in [other sections](../../commands/project_status), one of the benefits of `rv` is the ability to resolve and see what will happen
