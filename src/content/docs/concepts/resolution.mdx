...
* ***Direct** Dependencies* - These are the packages explicitly stated in the [dependencies section](../../config/common_config/#dependencies)
...
If a lockfile is not needed for your project, set the `[use_lockfile]`(../../config/additional_config#use_lockfile) config option to false.
